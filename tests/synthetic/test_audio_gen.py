...
class TestAudioGenerator:
    ...
    class TestBasicPatterns:
        ...
        def test_pattern_generation(self, pattern, temp_media_dir):
            ...
            config = AudioConfig(
                pattern=pattern, duration=1.0, sample_rate=44100, channels=2
            )
            generator = AudioGenerator(config)
    ...
    class TestAdvancedPatterns:
        ...
        def test_multi_tone(self, temp_media_dir):
            ...
            config = AudioConfig(
                pattern=AudioPattern.MULTI_TONE, frequencies=frequencies, duration=1.0
            )
            generator = AudioGenerator(config)
    ...
    class TestConfiguration:
        ...
        def test_sample_rates(self, sample_rate, temp_media_dir):
            ...
            config = AudioConfig(pattern=AudioPattern.SINE, sample_rate=sample_rate)
            generator = AudioGenerator(config)
        ...
        def test_channel_configurations(self, channels, temp_media_dir):
            ...
            config = AudioConfig(pattern=AudioPattern.SINE, channels=channels)
            generator = AudioGenerator(config)
            output_file = generator.generate(temp_media_dir / "test.flac")
    ...
    class TestPerformance:
        ...
        def test_high_sample_rate(self, temp_media_dir):
            ...
            config = AudioConfig(
                pattern=AudioPattern.SINE, sample_rate=96000, duration=1.0
            )
            generator = AudioGenerator(config)
