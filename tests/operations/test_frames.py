...
class TestFrameExtractor:
    ...
    class TestBasicExtraction:
        ...
        def test_basic_extraction(self, test_video, temp_media_dir):
            ...
            assert (
                len(list(result.output_directory.glob("*.png"))) == result.total_frames
            )
    ...
    class TestOutputFormats:
        ...
        @pytest.mark.parametrize(
            "format,quality", [("png", 100), ("jpg", 95), ("png", 50), ("jpg", 75)]
        )
        def test_format_quality_combinations(
            self, test_video, temp_media_dir, format, quality
        ):
    ...
    class TestProgress:
        ...
        def test_progress_tracking(self, test_video, temp_media_dir):
            ...
            result = extractor.extract_frames(
                test_video, progress_callback=progress_callback
            )
